...
interface IMoraswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IMoraswapV2Factory extends Contract {
  ...
  interface: IMoraswapV2FactoryInterface;
