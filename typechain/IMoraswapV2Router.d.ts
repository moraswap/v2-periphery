...
interface IMoraswapV2RouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IMoraswapV2Router extends Contract {
  ...
  interface: IMoraswapV2RouterInterface;
